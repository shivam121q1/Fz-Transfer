      ...
      <div className="flex h-16 items-center justify-between">
        <div className="md:flex md:items-center md:gap-12">
          <a className="text-main dark:text-teal-600 flex justify-center items-center gap-4 text-3xl font-serif" href="#">
            ...
            <svg className="h-8" viewBox="0 0 28 24" fill="#007dfc" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        {token != null ? (<button className='text-main' onClick={Logout}> Logout</button>): (<div className="flex items-center gap-4">
